/**
 * Mint and send new USDC and USDT tokens to a specified address
 */
...
// Treasury caps from the new package
...
console.log("💸 Minting new USDC and USDT tokens");
...
const [usdcCoin] = tx.moveCall({
  ...
  arguments: [tx.object(USDC_TREASURY), tx.pure.u64(1_000_000_000_000)],
});
...
const [usdtCoin] = tx.moveCall({
  ...
  arguments: [tx.object(USDT_TREASURY), tx.pure.u64(1_000_000_000_000)],
});
