...
![alt text](https://img.shields.io/badge/Sui-Testnet-blue)

![alt text](https://img.shields.io/badge/TypeScript-SDK-blue)

![alt text](https://img.shields.io/badge/License-MIT-yellow.svg)

![alt text](https://img.shields.io/badge/Runtime-Bun-black)
...
k
x⋅y=k
), Ampere utilizes a 3-Dimensional Constant Mean Market Maker (CMMM) invariant:
L
=
(
R
...
​
 ...
 represents the reserves of assets A, B, and C.
L
L
 represents the geometric depth (liquidity).
...
Orbit 1 (Tight): 60% Weight | 
±
0.5
%
±0.5%
 Band (Captures 90% of daily volume).
Orbit 2 (Wide): 40% Weight | 
±
2.0
%
±2.0%
 Band (Safety buffer for volatility).
...
Phase 2: Pyth Network Oracle integration for Orbital Vaults.
...
Research References:
Paradigm: Orbital AMMs
Constant Function Market Makers (Angeris et al.)
